...
if (!isset($_COOKIE['email'])) {
    ...
    if (isset($_GET['button'])) {
        ...
        if ($op == "Pay") {
            ...
            $api_key = '27db7b2f-a02b-4ee0-bd1f-17e7caabef70';
            $collection_id = 'fdqvqglz';
            ...
            $data = array(
                ...
                'callback_url' => "http://defenderstore.infinityfreeapp.com/DefenderStore",
                'redirect_url' => "http://defenderstore.infinityfreeapp.com/DefenderStore/php/payment_update.php?userid=$email&mobile=$mobile&amount=$amount"
            );
